...
function resetWorkState(options={}){
  ...
  const squareBracket=document.getElementById("gameBracketSquare");
  const roundBracket=document.getElementById("gameBracketRound");
  if(gameMode) gameMode.checked=false;
  if(squareBracket) squareBracket.checked=true;
  if(roundBracket) roundBracket.checked=true;
