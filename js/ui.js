...
function updateGameModeControls(){
  ...
  const options=document.getElementById("gameModeBrackets");
  const bracketInputs=[
    document.getElementById("gameBracketSquare"),
    document.getElementById("gameBracketRound")
  ];
...
document.addEventListener("DOMContentLoaded",()=>{
  const gameMode=document.getElementById("enableGameMode");
  if(gameMode) gameMode.addEventListener("change",updateGameModeControls);
