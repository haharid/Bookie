...
(function(root){
  ...
  const fontCleaner = root.EmbeddedFontCleanerStep || (typeof require === 'function' ? require('./steps/embedded-font-cleaner-step.js') : null);
  ...
  pipeline.reset().use(scan).use(select).use(rewrite).use(remove).use(unusedCollect).use(unusedDetect).use(unusedRemove).use(fontCleaner).use(junkCleaner).use(cssCleanup).use(opfCleanup).use(navNcxCleanup).use(zipCleanup).use(reportStep);
